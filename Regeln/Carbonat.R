#-----------------------------------------------------------------------------------------------------
print("KA5-Klassifikation von Carbonatgehaltsstufen")
#-----------------------------------------------------------------------------------------------------
#Referenzeinheiten
r <- ru
head(r)
...
for(L in 1:length(S.L)){
  #Schichtweise Carbonatklassifikation
...
head(r@data)
#-----------------------------------------------------------------------------------------------------
print("Zusammenfassung der Carbonatgehaltsstufen-Schichten zu einer Zeichenfolge")
#-----------------------------------------------------------------------------------------------------
setwd((file.path(W.DIR,RULE.DIR)))
source("Carbonat2.R")
